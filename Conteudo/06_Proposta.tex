...
e ao autocuidado de pacientes diabéticos com acuidade visual prejudica, acessível à PDV\@.
...
A \autoref{tab-req-fun} mostra os requisitos funcionais da aplicação, estes que referem-se, principalmente, às funções e 
