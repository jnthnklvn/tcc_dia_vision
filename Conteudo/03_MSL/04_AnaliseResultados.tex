...
alterando apenas a primeira categoria chamada ``Marcação'', que se refere a linguagens de marcação da \emph{web},
...
\begin{table}[htb]
    \begin{center}
        \caption{Diretrizes e técnicas relacionadas a cada tipo de problema.}
        \label{tab-tec-pro-1}
...
ser visto na \autoref{tab-tec-uti-des-1}, existem várias limitações quanto a essa solução, mesmo considerando
...
A utilização de estratégias para o uso de leitores de tela, como atalhos para facilitar a navegação do usuário com DV
...
desenvolvido no presente trabalho, o DiaVision. Nessa tabela, os campos com o caractere ``V'' indicam que a técnica foi utilizada pelo trabalho,
e os com ``X'', por sua vez, indicam que a técnica não foi utilizada. Assim, das 15 funcionalidades mapeadas, 10 foram propostas
para o DiaVision, e 5 não foram.
...
das quais 10 foram consideradas no desenvolvimento da solução proposta, como mostra a 
