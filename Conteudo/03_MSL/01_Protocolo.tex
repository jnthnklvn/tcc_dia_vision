...
\begin{figure}[htb]
  \caption{\label{fig_res_sel_base}Quantidade de artigos aceitos ou rejeitados por base.}
  \begin{center}
...
Desse modo, a \autoref{fig_art_act_ano} exibe a distribuição desses artigos por ano de publicação e base de busca, mostrando uma clara
