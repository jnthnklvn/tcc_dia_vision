...
\begin{itemize}
    ...
    \item Capítulo \ref{ch:desenv} - Desenvolvimento do DiaVision: detalha o processo de desenvolvimento, os requisitos e as tecnologias utilizadas no sistema.
    \item Capítulo \ref{ch:conclusion} - Considerações Finais: apresenta as considerações finais deste trabalho e as melhorias que podem ser realizadas em trabalhos futuros.
\end{itemize}
