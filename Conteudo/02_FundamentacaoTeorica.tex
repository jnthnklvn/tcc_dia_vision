...
O diabetes vem se tornando um desafio global de saúde pública cada vez maior por conta do rápido aumento no número de casos nos últimos
...
Serviços de educação e apoio para o autogerenciamento do diabetes
...
Segundo a \citeonline{WHO2019}, mais de 1 bilhão dos casos de pessoas com DV poderiam ser prevenidos ou
...
categorizando-os em V (Violação), PV (Potencial Violação) e A (Alerta). Os resultados mostraram
que 94.8\%, 97.5\% e 66.4\% dos apps continham problemas relacionados a V, PV e A, respectivamente \cite{Yan2019}.
...
A ferramenta \textit{Mobile Accessibility Checker} da IBM\footnote{\url{https://www.ibm.com/}} possibilita a realização de testes automatizados em aplicações
...
Segundo estimativas de 2019, mais de 5 bilhões de pessoas no mundo possuem dispositivos móveis, sendo mais da metade destes, \textit{smartphones}
